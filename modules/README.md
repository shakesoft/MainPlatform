![Radzen Blazor Components](https://raw.githubusercontent.com/radzenhq/radzen-blazor/master/RadzenBlazorEngine/wwwroot/images/radzen-blazor-components.png)
...
Use Radzen.Server.sln to open and run Engine as Blazor server application or Radzen.WebAssembly.sln to open and run Engine as Blazor WebAssembly application. Radzen.sln has reference to all projects including tests.
